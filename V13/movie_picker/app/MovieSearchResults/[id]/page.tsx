                ...
                <div className=''>
                        <div className='top-nav flex justify-between items-center'>
                            <div className='right'>
                                ...
                                <span className='mr-5 dark:text-white'>{data.result.year}</span>
                                <span className='dark:text-white'>{data.result.runtime}m</span>
                            </div>
                            <div className='left'>
                                <div>
                        ...
                        <div>
                            <img src={data.result.posterURLs.original} alt={data.result.title} className='h-80'/>
                            <video src={data.result.youtubeTrailerVideoLink}></video>
                        </div>
